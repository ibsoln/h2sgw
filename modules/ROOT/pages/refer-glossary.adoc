...
include::partial$_featureCatalog.adoc[tag=auto-conflict-resolution]

include::partial$_featureCatalog.adoc[tag=logging]

Logging2::
include::concept-logging.adoc[tag=logging-summ]
